describe('doublydoublyLinkedList', function() {
  ...
  it('should return null when removeHead or removeTail is called on empty linked list', function() {
  ...
  it('should designate a new heal when new nodes are added to Head', function() {
